...
<footer class="p-4 bg-zinc-100 sm:p-6 dark:bg-zinc-800 overflow-x-hidden">
		...
		<?php 
			wp_nav_menu(
				array(
					...
					'anchor_class_0'   => 'font-bold text-gray-900  uppercase dark:text-white',
					'anchor_class'     => 'hover:underline mb-2 dark:text-zinc-400 text-zinc-600',
	...
	<div class="sm:flex sm:items-center sm:justify-between">
        <span class="text-sm text-zinc-500 sm:text-center dark:text-zinc-400"><?php echo date_i18n( 'Y' );?> - <?php echo get_bloginfo( 'name' );?>
        </span>
