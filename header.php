...
<div id="page" class="min-h-screen flex flex-col ">
	...
	<header class="">
		...
		<div class="mx-auto container">
			<div class="lg:flex lg:justify-between lg:items-center py-6">
				<div class="flex justify-between items-baseline">
					...
					<?php if($show_info) { ?>
						<div class="lg:hidden relative">
							...
							<button id="info_drop_btn" data-info_dropdown-toggle="info_dropdown" class="flex items-center mx-2 text-zinc-500 ">
							...
							<div 
								id="info_dropdown" 
								class="absolute top-[3.5em] hidden z-40 bg-white rounded shadow-lg "
							>
								<ul class="py-1 text-sm text-zinc-700 mx-5 ">
									
									<li class="flex items-center my-2">
										<?php if ($phone != "") { ?> 
											<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="mx-2 block text-zinc-600 ">
												<path fill-rule="evenodd" d="M1.885.511a1.745 1.745 0 0 1 2.61.163L6.29 2.98c.329.423.445.974.315 1.494l-.547 2.19a.678.678 0 0 0 .178.643l2.457 2.457a.678.678 0 0 0 .644.178l2.189-.547a1.745 1.745 0 0 1 1.494.315l2.306 1.794c.829.645.905 1.87.163 2.611l-1.034 1.034c-.74.74-1.846 1.065-2.877.702a18.634 18.634 0 0 1-7.01-4.42 18.634 18.634 0 0 1-4.42-7.009c-.362-1.03-.037-2.137.703-2.877L1.885.511z"/>
											</svg>

											<a href="tel:<?php echo $phone; ?>" class="mr-6 text-sm font-medium text-zinc-500  ?></a>
											
										<?php } ?>
									</li>
		
									<hr class="my-3 border-zinc-200 lg:mx-auto ">
									...
									<li class="flex items-center my-2">
										<?php if ($email != "") { ?> 
											...
											<a href="mailto: <?php echo $email; ?>" class="mr-6 text-sm font-medium text-zinc-500  ?></a>
									...
									<li class="flex items-center my-2">
										<?php if ($location != "") { ?> 
											<svg class="mx-2 block text-zinc-600 ">
												<path d="M8 16s6-5.686 6-10A6 6 0 0 0 2 6c0 4.314 6 10 6 10zm0-7a3 3 0 1 1 0-6 3 3 0 0 1 0 6z"/>
											</svg>

											<?php if ($location_link != "") { ?>
												<a class="mr-6 text-sm font-medium text-zinc-500  ?></a>
											<?php } else {?>
												<p class="mr-6 text-sm font-medium text-zinc-500  ?></p>
											<?php }?>  
					...
					<div>
						<button type="button" class="theme-toggle mx-2 lg:hidden block text-zinc-500 ">
				...
				<div class="items-center lg:flex hidden shrink-0">
					...
					<button type="button" class="theme-toggle mx-2 lg:block hidden text-zinc-500 ">
						<svg class="theme-toggle-dark-icon hidden w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M17.293 13.293A8 8 0 016.707 2.707a8.001 8.001 0 1010.586 10.586z"></path></svg>
						<svg class="theme-toggle-light-icon hidden w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M10 2a1 1 0 011 1v1a1 1 0 11-2 0V3a1 1 0 011-1zm4 8a4 4 0 11-8 0 4 4 0 018 0zm-.464 4.95l.707.707a1 1 0 001.414-1.414l-.707-.707a1 1 0 00-1.414 1.414zm2.12-10.607a1 1 0 010 1.414l-.706.707a1 1 0 11-1.414-1.414l.707-.707a1 1 0 011.414 0zM17 11a1 1 0 100-2h-1a1 1 0 100 2h1zm-7 4a1 1 0 011 1v1a1 1 0 11-2 0v-1a1 1 0 011-1zM5.05 6.464A1 1 0 106.465 5.05l-.708-.707a1 1 0 00-1.414 1.414l.707.707zm1.414 8.486l-.707.707a1 1 0 01-1.414-1.414l.707-.707a1 1 0 011.414 1.414zM4 11a1 1 0 100-2H3a1 1 0 000 2h1z" fill-rule="evenodd" clip-rule="evenodd"></path></svg>
					</button>
				</div>
		...
		<hr class="hidden lg:block my-3 border-zinc-300 lg:mx-auto ">
		...
		<nav class="lg:hidden bg-white ">
			<div class="mx-auto w-3/4 max-w-md">
				<?php if ( has_custom_logo() ) { ?>
						<?php the_custom_logo(); ?>
					<?php } else { ?>
						<div class="text-center flex-1 text-lg uppercase ">
							<a href="<?php echo get_bloginfo( 'url' ); ?>" class="font-extrabold text-lg uppercase">
								<?php echo get_bloginfo( 'name' ); ?>
							</a>
						</div>
		
						<p class="text-center flex-1 text-sm font-light ">
							<?php echo get_bloginfo( 'description' ); ?>
						</p>		
					<?php } ?>
			</div>	
		...
		<hr class="mt-3 border-zinc-200 lg:mx-auto ">
